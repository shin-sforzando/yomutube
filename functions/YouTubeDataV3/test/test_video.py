        ...
        if include_optional:
            return Video(
                ...
                snippet = openapi_client.models.snippet.Snippet(
                    ...
                    description = '',
                    thumbnails = {
                        'key' : openapi_client.models.thumbnail.Thumbnail(
                            url = '',
                            width = 56,
                            height = 56, )
                        },
                    ...
                    default_language = '',
                    localized = openapi_client.models.localized.Localized(
                        title = '',
                        description = '', ),
                    default_audio_language = '', ),
                content_details = openapi_client.models.content_details.ContentDetails(
                    duration = '',
                    dimension = '',
                    definition = 'hd',
                    caption = 'false',
                    licensed_content = True,
                    region_restriction = openapi_client.models.content_details_region_restriction.ContentDetails_regionRestriction(
                        allowed = [
                            ''
                            ],
                        blocked = [
                ...
                player = openapi_client.models.player.Player(
                    ...
                    embed_height = 56,
                    embed_width = 56, ),
                topic_details = openapi_client.models.topic_details.TopicDetails(
                    topic_ids = [
                        ''
                        ],
                    relevant_topic_ids = [
                ...
                recording_details = openapi_client.models.recording_details.RecordingDetails(
                    recording_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                file_details = openapi_client.models.file_details.FileDetails(
                    file_name = '',
                    file_size = 56,
                    file_type = 'video',
                    container = '',
                    video_streams = [
                        openapi_client.models.file_details_video_streams_inner.FileDetails_videoStreams_inner(
                            width_pixels = 56,
                            height_pixels = 56,
                    ...
                    audio_streams = [
                        openapi_client.models.file_details_audio_streams_inner.FileDetails_audioStreams_inner(
                            channel_count = 56,
                            codec = '',
                            bitrate_bps = 56,
                            vendor = '', )
                    ...
                    bitrate_bps = 56,
                    creation_time = '', ),
                processing_details = openapi_client.models.processing_details.ProcessingDetails(
                    processing_status = 'succeeded',
                    processing_progress = openapi_client.models.processing_details_processing_progress.ProcessingDetails_processingProgress(
                        parts_total = 56,
                        parts_processed = 56,
                        time_left_ms = 56, ),
                ...
                suggestions = openapi_client.models.suggestions.Suggestions(
                    processing_errors = [
                        'archiveFile'
                        ],
                    processing_warnings = [
                    ...
                    tag_suggestions = [
                        openapi_client.models.suggestions_tag_suggestions_inner.Suggestions_tagSuggestions_inner(
                            tag = '',
                            category_restricts = [
                                ''
                                ], )
                ...
                live_streaming_details = openapi_client.models.live_streaming_details.LiveStreamingDetails(
                ...
                localizations = {
                    'key' : {
                        'key' : openapi_client.models.localization_value.Localization_value(
                            title = '',
                            description = '', )
                        }
                    }
