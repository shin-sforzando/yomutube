...
class TopicDetails(BaseModel):
    ...
    topic_ids: Optional[List[StrictStr]] = Field(default=None, alias="topicIds")
    relevant_topic_ids: Optional[List[StrictStr]] = Field(
        default=None, alias="relevantTopicIds"
    )
    topic_categories: Optional[List[StrictStr]] = Field(
        default=None, alias="topicCategories"
    )
