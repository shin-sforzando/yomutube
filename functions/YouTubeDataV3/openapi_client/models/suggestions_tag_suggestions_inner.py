...
class SuggestionsTagSuggestionsInner(BaseModel):
    """
    SuggestionsTagSuggestionsInner
    """  # noqa: E501

    tag: Optional[StrictStr] = Field(
        default=None, description="The keyword tag suggested for the video."
    )
    category_restricts: Optional[List[StrictStr]] = Field(
        default=None, alias="categoryRestricts"
    )
    __properties: ClassVar[List[str]] = ["tag", "categoryRestricts"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {"tag": obj.get("tag"), "categoryRestricts": obj.get("categoryRestricts")}
        )
        return _obj
