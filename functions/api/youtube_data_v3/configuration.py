...
class Configuration:
    ...
    conf = youtube_data_v3.Configuration(
    ...
    def __init__(
        ...
        """Constructor"""
        self._base_path = (
            "https://www.googleapis.com/youtube/v3" if host is None else host
        )
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("youtube_data_v3")
