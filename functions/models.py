...
#   timestamp: 2024-01-18T06:46:41+00:00
...
class VideoCategorySnippet(BaseModel):
    ...
    title: str = Field(..., description="The video category's title.")
...
class Thumbnail(BaseModel):
    ...
    url: str = Field(..., description="The URL of the thumbnail image.")
...
class Status(BaseModel):
    ...
    uploadStatus: Optional[str] = Field(
        None,
    ...
    privacyStatus: Optional[str] = Field(
        None,
...
class Player(BaseModel):
    ...
    embedHtml: Optional[str] = Field(
        None,
        description="An `<iframe>` tag that embeds a player that plays the video. If the API request to retrieve the resource specifies a value for the maxHeight and/or maxWidth parameters, the size of the embedded player is scaled to satisfy the maxHeight and/or maxWidth requirements. If the video's aspect ratio is unknown, the embedded player defaults to a 4:3 format.",
    )
    embedHeight: Optional[int] = Field(
        None,
        description="The height of the embedded player returned in the `player.embedHtml` property. This property is only returned if the request specified a value for the maxHeight and/or maxWidth parameters and the video's aspect ratio is known.",
    )
    embedWidth: Optional[int] = Field(
        None,
        description="The width of the embedded player returned in the `player.embedHtml` property. This property is only returned if the request specified a value for the maxHeight and/or maxWidth parameters and the video's aspect ratio is known.",
    )
...
class TopicDetails(BaseModel):
    ...
    topicIds: Optional[List[str]] = Field(
        None,
        description="Important: This property has been deprecated as of November 10, 2016. The API no longer returns values for this property, and any topics associated with a video are now returned by the `topicDetails.relevantTopicIds[]` property value.",
    )
    relevantTopicIds: Optional[List[str]] = Field(
        None,
        description="A list of topic IDs that are relevant to the video. Important: This property has been deprecated as of November 10, 2016. It will be supported until November 10, 2017.",
    )
...
class Suggestions(BaseModel):
    ...
    processingErrors: Optional[List[str]] = Field(
        None,
    ...
    processingWarnings: Optional[List[str]] = Field(
        None,
    ...
    processingHints: Optional[List[str]] = Field(
        None,
    ...
    editorSuggestions: Optional[List[str]] = Field(
        None,
...
class Localization(RootModel[Optional[Dict[str, Localization1]]]):
    ...
    root: Optional[Dict[str, Localization1]] = None
...
class Snippet1(BaseModel):
    ...
    audioTrackType: Optional[str] = Field(
        None,
...
class Caption(BaseModel):
    ...
    etag: str = Field(..., description="The Etag of this resource.", examples=["etag"])
    id: str = Field(
        ...,
        description="The ID that YouTube uses to uniquely identify the caption track.",
        examples=["id"],
    )
    snippet: Snippet1 = Field(
...
class Snippet(BaseModel):
    ...
    publishedAt: AwareDatetime = Field(
        ...,
    ...
    liveBroadcastContent: Optional[str] = Field(
        None,
