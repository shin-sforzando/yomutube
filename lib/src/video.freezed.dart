...
class _$VideoImpl with DiagnosticableTreeMixin implements _Video {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Video(id: $id, title: $title, description: $description, thumbnailUrl: $thumbnailUrl, summary: $summary, updatedAt: $updatedAt)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, title, description, thumbnailUrl, summary, updatedAt);
...
abstract class _Video implements Video {
  const factory _Video(
      ...
      @UpdatedAtField() required final DateTime? updatedAt}) = _$VideoImpl;
